    ...
    try {
      ...
      if (onSelectChat) {
        onSelectChat({
          ...
          dp: otherUser?.dp || "https://i.pravatar.cc/150",
          avatar: otherUser?.dp || "https://i.pravatar.cc/150",
      ...
      <AnimatePresence>
        {isOpen && query.length > 1 && (
          ...
          >
            <div className="p-2">
              {searching ? (
                <p className="text-xs text-gray-500 p-4 text-center italic">
                  Searching...
                </p>
              ) : results.length ? (
                results.map((u) => (
                  ...
                  >
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-[10px] text-gray-400 truncate w-40">
                        {u.status}
                      </p>
                    </div>
                  </button>
